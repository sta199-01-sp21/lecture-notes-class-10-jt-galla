...
There is a 43 / 84 (51.2%) chance of selecting one receiving the placebo.

- What is the probability a randomly selected patient received the placebo
  and had a marked improvement?
There is a 7 / 84 (8.33%) chance of selecting one receiving placebo and with
a marked improvement.
  
- What is the probability a randomly selected patient received the placebo
  and the treatment?
There is a 84 / 84 (100%) chance of selecting one receiving the placebo or
the treatment.
  
- What is the probability a randomly selected patient had some improvement or
  was on the treatment?
There is a (14 / 84) + (41 / 84) (16.7% + 48.8% = 65.5%) chance of selecting 
one who had some imporvement or was on the treatment.
...
There is a 3 / 8 (37.5%) of pulling a blue, and a 1 / 8 (12/5%) of pulling a
white.
...
It is almost spot on! 12.49% approximately equals 12.5%, especially if you
round!
...
Whatever the probability of drawing the color once squared. 
...
I think the first option is more likely because it has more routes to get there
(6 options vs 4 options)
...
```{r identify_events}
two_roll_results1 <- two_roll_results %>% 
  mutate(roll_match = roll_1 == roll_2)
two_roll_results2 <- two_roll_results %>%
  mutate(roll_right = (4 == (roll_1 - roll_2)) | (4 == (roll_2 - roll_1)))
```
